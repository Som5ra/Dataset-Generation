...
def main():
    ...
    parser.add_argument("-bo",
                        "--background_output",
                        default="background_used",
                        type=str)
    args = parser.parse_args()

    # print("images: ", args.images)
    # print("backgrounds: ", args.backgrounds)
    # print("output: ", args.output)
    # print("output: ", args.background_output)
    ...
    os.makedirs(args.background_output, exist_ok=True)
    ...
    for file_name in os.listdir(args.images):
        ...
        if file_name.lower().endswith(args.types):
            ...
            shutil.copy2(background_path, args.background_output)
            ...
            background.info.pop('icc_profile', None)
            ...
            # Else store merged image in default or provided `output` directory
                ...
                if args.output == "output":
                    ...
                    background.save(os.path.join(args.output, file_name))
